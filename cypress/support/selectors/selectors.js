export const selectors = {
    ...
    jobs: {
        ...
        // jobTypeSelect: 'button[role="combobox"], [placeholder="Select Job Type"]',
        interviewDurationSelect: 'button[role="combobox"], [placeholder="Select Interview Duration"]',
        interviewLanguageSelect: 'button[role="combobox"], [placeholder="English"]',
        askForResumeCheckbox: '#c1',
        resumeRequired: '#resume_required',
        resumeOptional: '#resume_optional',
        proceedButton: 'button:contains("Proceed")',
